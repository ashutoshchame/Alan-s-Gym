...
<dl>Adminname</dl><input type="text" name="adminname" placeholder="Your Adminname"><br>
<dl>Password</dl><input type="password" name="adminpassword" placeholder="Your Password"><br>
...
<a href="BackAdminlogin"> Back To Login</a>
</form>
</center>
</div>
