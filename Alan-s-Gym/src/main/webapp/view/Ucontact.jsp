...
<center>
<h4>Contact Us</h4>
<form  action="Ucontact">

<dl>Name</dl><input  type="text" name="cname" placeholder="Your Name" ><br>
<dl>Age</dl><input type="text" name="cage" placeholder="Your Age"><br>
<dl>City</dl><input type="text" name="ccity" placeholder="Your City"><br>
<dl>Mobile No.</dl><input type="text" name="cmobileno" placeholder="Your Mobile Number"><br>

<button type="submit" class="btn btn-primary btn-md mt-2">Submit</button>
<button type="reset" class="btn btn-secondary btn-md mt-2">Reset</button>
 </form>
</center>
</div>
<!-- Footer start -->
